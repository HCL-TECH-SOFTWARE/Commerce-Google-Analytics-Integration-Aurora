...
console.log('promotionelements'+promotionsElements);


promotionsElements.each(
(index,element)=>{
console.log(element)
let contentId =element.id.substr(9,4);
console.log(contentId)
let contentName= $(element).find('div')[1].innerText;
...
gaDataService.sendPromotionImpression(promo);
}
)
});
