...
var pgorder = <wcf:json object="${pagorder.orderItem}" />;
var itemdetail =<wcf:json object="${itemDetailsInThisOrder}" />;
gaDataService.sendDataItems(pgorder,itemdetail);
});
