...
<script>
	...
	$(document).ready(function(){
		gaDataService.sendMyAccountPageViewEvent();
	});
	// GA Integration ended
</script>

<flow:ifEnabled feature="Analytics"><cm:registration personJSON="${person}"/><cm:pageview pageType="wcs-registration"/></flow:ifEnabled>
