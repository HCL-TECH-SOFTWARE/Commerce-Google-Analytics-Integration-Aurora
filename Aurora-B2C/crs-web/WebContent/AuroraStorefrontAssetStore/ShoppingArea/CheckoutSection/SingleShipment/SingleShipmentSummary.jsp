...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${shortLocale}" xml:lang="${shortLocale}">
										...
										<div class="body shipping_billing_height" id="WC_SingleShipmentSummary_div_13">
											...
											<div class="button_footer_line" id="WC_SingleShipmentSummary_div_31_1">
												...
												<c:choose>
													...
													<c:otherwise>
														<a role="button" class="button_primary button_left_padding tlignore" id="singleOrderSummary" tabindex="0" href="javascript:setCurrentId('singleOrderSummary'); CheckoutHelperJS.checkoutOrder(<c:out value="${order.orderId}"/>,'<c:out value='${userType}'/>','<c:out value='${addressListForMailNotification}'/>'); gaDataService.sendCheckoutEvent('Step 3', 'Review');">
															<div class="left_border"></div>
															<div class="button_text"><fmt:message bundle="${storeText}" key="ORDER"/></div>
															<div class="right_border"></div>
														</a>
	...
	<script>
		...
		// checkout page view and checkout event - step 2
		$(document).ready(function(){
			gaDataService.sendCheckoutPageViewEvent("Order Summary");
			gaDataService.sendCheckoutEvent('Step 2', 'Payment');
		});
